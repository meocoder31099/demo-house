<script lang="ts">
	const backLink = [
		...
		{
			title: 'DỊCH VỤ',
			item: ['Thiết Kế Kiến Trúc', 'Thiết Kế Nội Thất', 'Thi Công Xây Dựng', 'Thi Công Nội Thất']
		}
	];
</script>

<!-- From -->
<section class="py-16 bg-[#2e0249]">
	<div class="w-full max-w-screen-fhd mx-auto my-10 px-4 md:px-16 screen-fhd:px-6">
		<div class="grid lg:grid-cols-2 items-center gap-14">
			<div>
				<h1 class="text-4xl font-bold text-white">Liên hệ với chúng tôi</h1>
				<p class="text-gray-300 mt-4 leading-relaxed">
					Bạn đang có dự án cần hỗ trợ? <br> Liên hệ với chúng tôi ngay để được tư vấn và hỗ trợ xây dựng dự án của bạn hoàn toàn miễn phí.
				</p>
				...
				<ul class="mt-12 space-y-8">
					<li class="flex items-center">
						...
						<a href="/" class="text-white ml-4"> info@example.com </a>
					</li>
					<li class="flex items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						<a href="/" class="text-white ml-4"> 0969.461.890 </a>
					</li>
					<li class="flex items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
						...
						<a href="/" class="text-white ml-4"> Số 499 đường Lương Thế Vinh, phường Mễ Trì, quận Nam Từ Liêm, Hà Nội </a>
					</li>
				</ul>

				<ul class="flex mt-12 space-x-4">
					<li
						class="bg-[#a91079] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0"
					>
						<a href="/">
							<svg
								xmlns="http://www.w3.org/2000/svg"
			...
			<div class="bg-gray-100 p-6 rounded-lg">
				<form>
					...
					<div class="relative z-0 w-full mb-5 group">
						<input
							type="number"
							name="floating_dien_thoai"
							id="floating_dien_thoai"
							class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
							placeholder=" "
							required
						/>
						<label
							for="floating_dien_thoai"
							class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
							>Số điện thoại (*)</label
						>
					</div>
					...
					<button
						type="submit"
						class="text-white bg-[#a91079] hover:bg-[#a91079e2] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
						>Gửi yêu cầu</button
					>
				</form>
			</div>
			...
			{#each backLink as BLItem}
				<div>
					...
					<ul class="text-gray-500 font-medium">
						{#each BLItem.item as item}
							<li class="mb-4 last:mb-0">
								<a href="https://flowbite.com/" class="hover:underline">{item}</a>
							</li>
						{/each}
					</ul>
				</div>
			...
			<div class="mb-6 md:mb-0">
				...
				<div>
					<ul class="text-gray-500">
						...
						<li class="mb-4 last:mb-0">
							<a href="https://flowbite.com/" class="hover:underline"
								>Khu đô thị Vạn Phúc, Quốc lộ 13, phường Hiệp Bình Phước, TP. Thủ Đức, TP. HCM</a
							>
						</li>
					</ul>
				</div>
